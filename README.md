Jupyter Notebooks presenting all steps taken in training a forest of gradient-boosted decision trees using XGBoost, ultimately achieving a somewhat-high-performing classifier.
